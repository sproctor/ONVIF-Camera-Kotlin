...
internal actual fun parseOnvifProfiles(input: String): List<MediaProfile> {
...
internal actual fun parseOnvifStreamUri(input: String): String {
    var result = ""
...
internal actual fun parseOnvifDeviceInformation(input: String): OnvifDeviceInformation {
