 ...
 *
 * The constructor is `@JvmOverloads` so the three-argument JVM signature published before
 * [width]/[height] existed stays callable by already-compiled consumers.
 */
public data class MediaProfile @JvmOverloads public constructor(
    val token: String,
    val name: String?,
    val encoding: String?,
    val width: Int? = null,
